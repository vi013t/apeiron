...
new SimpleMenuProvider(
	...
	/**
	 * Called when the resulting item is taken. For example, in an anvil, this checks if the anvil needs to break, and takes experience from the player. For
	 * the Tinker Table, this just needs to delete the input items.
	 */
	@Override
