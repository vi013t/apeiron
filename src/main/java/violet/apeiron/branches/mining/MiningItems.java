...
public class MiningItems {
	...
	public static final DeferredItem<MaterialItem> ANDALUSITE_NUGGET = item("andalusite_nugget", MaterialItem.create(MiningMaterial.ANDALUSITE));
	...
	public static final DeferredItem<MaterialItem> DANBURITE_NUGGET = item("danburite_nugget", MaterialItem.create(MiningMaterial.DANBURITE));
	...
	public static final DeferredItem<MaterialItem> CHROMITE_NUGGET = item("chromite_nugget", MaterialItem.create(MiningMaterial.CHROMITE));
	...
	public static final DeferredItem<MaterialItem> CUPRITE_NUGGET = item("cuprite_nugget", MaterialItem.create(MiningMaterial.CUPRITE));
	...
	public static final DeferredItem<MaterialItem> TUGTUPITE_NUGGET = item("tugtupite_nugget", MaterialItem.create(MiningMaterial.TUGTUPITE));
	...
	public static final DeferredItem<MaterialItem> KYANITE_NUGGET = item("kyanite_nugget", MaterialItem.create(MiningMaterial.KYANITE));
	...
	public static final DeferredItem<MaterialItem> TANZANITE_NUGGET = item("tanzanite_nugget", MaterialItem.create(MiningMaterial.TANZANITE));
	...
	public static final DeferredItem<MaterialItem> SPHALERITE_NUGGET = item("sphalerite_nugget", MaterialItem.create(MiningMaterial.SPHALERITE));
	...
	public static final DeferredItem<MaterialItem> ADAMITE_NUGGET = item("adamite_nugget", MaterialItem.create(MiningMaterial.ADAMITE));
