...
/**
 * A weapon modifier. This is an interface implemented by some classes that extend {@link violet.apeiron.api.modifiers.data.Modifier Modifier}, specifically those that can be applied to weapons.
