...
|                      | Gain permanent fire resistance.                                                              | Flario           | 8    | Magic       |
|                      | Right click to instantly smelt items in your hotbar.                                         | Niobium          | 8    | Tech        |
|                      |                                                                                              | Phoenix Feather  | 8    | Boss        |
|                      | Light hostile enemies on fire by looking at them from afar.                                  | Fueim            | 8    | Exploration |
|                      |                                                                                              | Vibrus           | 8    | Farming     |
|                      |                                                                                              |                  | 8    | Drops       |
|                      |                                                                                              |                  | 8    | Building    |
...
|                      |                                                                                              | Cyclops Eye      | 9    | Boss        |
|                      |                                                                                              | Aquim            | 9    | Exploration |
|                      | Right click two animals to breed them. Right click a baby animal to grow it up instantly.    | Hydrangus        | 9    | Farming     |
|                      |                                                                                              |                  | 9    | Drops       |
|                      |                                                                                              |                  | 9    | Building    |
...
| Tardic               | Gain infinite player-bound storage.                                                          | Iridium          | 10   | Tech        |
| Flight               | Allows the player to fly.                                                                    | Dragon Scale     | 10   | Boss        |
| Instant Transmission | Teleport to any coordinates, including saved presets.                                        | Arcim            | 10   | Exploration |
| Angelic              | Right click crops to grow them instantly. Permanent saturation.                              | Iris             | 10   | Farming     |
